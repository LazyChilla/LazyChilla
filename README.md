<p align="center"><img src="images/logo.jpg" width="300" alt="LazyChilla" /></p>

<h1 align="center">🚜 LazyChilla — FS25 Mods</h1>

<p align="center"><b>Human Concept. AI Code. Next Level Tools.</b></p>

<p align="center">
Praktische Quality-of-Life-Mods für den <b>Landwirtschafts-Simulator 25</b> — kostenlos & quelloffen.<br>
Practical quality-of-life mods for <b>Farming Simulator 25</b> — free & open-source.<br>
📍 Luxembourg 🇱🇺
</p>
...
Ein Klick auf **⬇️ Download** lädt immer die neueste Version. &nbsp;·&nbsp; A click on **⬇️ Download** always fetches the latest version.

| | Mod | Was er macht &nbsp;·&nbsp; What it does | |
|:--:|---|---|:--:|
| <img src="images/implementcheck.jpg" width="200"> | **Implement Check** | Gleicht Traktoren & Anbaugeräte nach PS ab: im Shop, als Live-Warnung beim Ankuppeln und mit Pflegereifen-Filter im Fahrzeugmenü. <br> _Matches tractors & implements by power — in the shop, as a live warning when attaching, and with a care-tyre filter in the vehicle menu._ | [⬇️](https://github.com/LazyChilla/FS25_ImplementCheck/releases/latest) |
| <img src="images/balernetz.jpg" width="200"> | **Endless Baler Supplies** | Ballennetz, Bindegarn und Wickelfolie werden nicht mehr verbraucht — nie wieder mitten im Feld nachladen. <br> _Bale net, twine and wrapping film are no longer consumed — never reload mid-field again._ | [⬇️](https://github.com/LazyChilla/FS25_BalerNetzEndlos/releases/latest) |
| <img src="images/haecksler.jpg" width="200"> | **Forage Harvester Stop** | Der Feldhäcksler nimmt keine Frucht mehr vom Feld, sobald er nicht abladen kann — kein Ernteverlust, wenn der Abfahrer weg ist. <br> _The forage harvester stops taking crop the moment it can't unload — no harvest lost when the trailer is away._ | [⬇️](https://github.com/LazyChilla/FS25_HaeckslerErnteStopp/releases/latest) |
| <img src="images/dispolist.jpg" width="200"> | **DispoList** | HUD mit Lagerübersicht und den besten Verkaufspreisen — mit Live-Suche und Filtern nach Bereichen, Stationen und Presets; zeigt auch den Materialbedarf laufender Baustellen. <br> _HUD with stock overview and best selling prices — live search and filters by areas, stations and presets; also shows the material demand of active construction sites._ | [⬇️](https://github.com/LazyChilla/FS25_DispoList/releases/latest) |
| <img src="images/fieldprice.jpg" width="200"> | **Field Price Monitor** | Feldpreis-Übersicht mit Anbindung an die BetterContracts-Rabatte. <br> _Field price overview with BetterContracts discount integration._ | [⬇️](https://github.com/LazyChilla/FS25_FieldPriceMonitor/releases/latest) |
| <img src="images/seedselector.jpg" width="200"> | **Seed Selector** | Scrollbare Saatgutauswahl direkt an der Sämaschine — alphabetisch sortiert und mit Rücksicht auf den Saatkalender (Aussaatzeiten). <br> _Scrollable seed selection right at the seeder — sorted alphabetically and aware of the planting calendar (sowing periods)._ | [⬇️](https://github.com/LazyChilla/FS25_SeedSelector/releases/latest) |
...
| | Mod | |
|:--:|---|---|
| <img src="images/farmassistant.jpg" width="150"> | **FarmAssistant** | Feldarbeits-Assistent: zeigt auf einen Blick, welche Felder düngen, kalken, Steine sammeln oder ernten wollen. <br> _Field-work assistant: see at a glance which fields need fertiliser, lime, stone-picking or harvesting._ |
| <img src="images/gotonextfield.jpg" width="150"> | **GoToNextField** | Zeigt dir direkt vom Fahrersitz, welches Feld sich mit dem aktuell angehängten Gerät als nächstes bearbeiten lässt. <br> _Shows you, right from the driver's seat, which field can be worked next with your currently attached implement._ |
| <img src="images/saatplan.jpg" width="150"> | **Saatplan-Assistent** | Hilft dir, den Anbau in Richtung voller Autarkie für deine aktiven eigenen Produktionen zu optimieren. <br> _Helps you optimise your cropping toward full self-sufficiency for your active own productions._ |
...
- **Endless Baler Supplies** — Filet, ficelle et film ne sont plus consommés. → [Télécharger](https://github.com/LazyChilla/FS25_BalerNetzEndlos/releases/latest)
- **Forage Harvester Stop** — L'ensileuse arrête de récolter dès qu'elle ne peut plus décharger — aucune perte quand la remorque est loin. → [Télécharger](https://github.com/LazyChilla/FS25_HaeckslerErnteStopp/releases/latest)
...
_Bientôt : FarmAssistant, GoToNextField, Assistant de plan de semis._
...
- **Endless Baler Supplies** — Rete, spago e pellicola non si consumano più. → [Scarica](https://github.com/LazyChilla/FS25_BalerNetzEndlos/releases/latest)
- **Forage Harvester Stop** — La trinciatrice smette di raccogliere quando non può scaricare — nessuna perdita se il rimorchio è lontano. → [Scarica](https://github.com/LazyChilla/FS25_HaeckslerErnteStopp/releases/latest)
...
_Presto: FarmAssistant, GoToNextField, Assistente piano di semina._
...
- **Endless Baler Supplies** — Rede, fio e filme deixam de ser consumidos. → [Descarregar](https://github.com/LazyChilla/FS25_BalerNetzEndlos/releases/latest)
- **Forage Harvester Stop** — A ensiladeira para de colher assim que não consegue descarregar — sem perdas quando o reboque está longe. → [Descarregar](https://github.com/LazyChilla/FS25_HaeckslerErnteStopp/releases/latest)
...
_Em breve: FarmAssistant, GoToNextField, Assistente de plano de sementeira._
...
- **Endless Baler Supplies** — Red, cuerda y film ya no se consumen. → [Descargar](https://github.com/LazyChilla/FS25_BalerNetzEndlos/releases/latest)
- **Forage Harvester Stop** — La picadora deja de cosechar en cuanto no puede descargar — sin pérdidas cuando el remolque está lejos. → [Descargar](https://github.com/LazyChilla/FS25_HaeckslerErnteStopp/releases/latest)
...
_Pronto: FarmAssistant, GoToNextField, Asistente de plan de siembra._
